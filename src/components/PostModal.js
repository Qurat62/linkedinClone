...
const PostModal = (props) => {
  ...
  const postArticle=(e)=>
  {
    ...
    console.log("before line 51 ",payload);
            ...
            <ShareCreation>
              <AttachAssets>
                <AssetButton onClick={() => switchAssetArea("image")}>
                  <img src="/images/post-image-icon.svg" alt="" />
                </AssetButton>
                <AssetButton onClick={() => switchAssetArea("media")}>
                  <img src="/images/post-video-icon.svg" alt="" />
                </AssetButton>
                <AssetButton>
                  <img src="/images/post-notes-icon.svg" alt="" />
                </AssetButton>
                <AssetButton>
...
const Container = styled.div`
  position: fixed;
  //we do 0 0 0  0 to take over the entire browser
  top: 0;
  left: 0;
  right: 0;
  bottom: 0;
